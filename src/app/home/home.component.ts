...
export class HomeComponent{
  ...
  filterById="";
    ...
    },
    {
      ...
      "name": "Gaming Mouse",
      "rating": 4.7,
      "description": "Improve your gaming performance with this high-quality gaming mouse.",
      "price": 49.99,
      "discount": 10,
    ...
    },
    {
      ...
      "rating": 4.3,
      "description": "Track your fitness goals and stay motivated with this fitness tracker.",
      "price": 69.99,
      "discount": 10,
    ...
    },
    {
      ...
      "name": "Action Camera",
      "rating": 4.9,
      "description": "Capture all your adventures with this high-quality action camera.",
      "price": 129.99,
      "discount": 20,
    ...
    },
    {
      ...
      "rating": 4.6,
      "description": "Charge your phone without cables with this wireless charging pad.",
      "price": 19.99,
      "discount": 5,
    ...
    },
    {
      ...
      "rating": 4.5,
      "description": "Get a faster and more reliable internet connection with this wireless router.",
      "price": 79.99,
      "discount": 15,
    ...
    },
    {
      ...
      "rating": 4.7,
      "description": "Keep all your important files backed up with this external hard drive.",
      "price": 129.99,
      "discount": 20,
    ...
    },
    {
      ...
      "name": "Smart Scale",
      "rating": 4.2,
      "description": "Track your weight and body composition with this smart scale.",
      "price": 49.99,
      "discount": 10,
    ...
    },
    {
      ...
      "rating": 4.4,
      "description": "Improve your typing experience with this wireless keyboard.",
      "price": 39.99,
      "discount": 5,
    ...
    },
    {
      ...
      "rating": 4.9,
      "description": "Block out distractions and focus on your work with these noise cancelling headphones.",
      "price": 129.99, 
      "discount": 15,
    ...
    },
    {
      ...
      "rating": 4.0,
      "description": "Make and receive calls hands-free with this Bluetooth headset.",
      "price": 49.99,
      "discount": 5,
    ...
    },
    {
      ...
      "rating": 4.8,
      "description": "Get a thorough clean for your teeth and gums with this electric toothbrush.",
      "price": 89.99,
      "discount": 15,
    ...
    },
    {
      ...
      "name": "Smart Doorbell",
      "rating": 4.6,
      "description": "See who's at your door from your phone with this smart doorbell.",
      "price": 149.99,
      "discount": 10,
    ...
    },
    {
      ...
      "rating": 4.3,
      "description": "Listen to your music without tangled wires with these wireless earbuds.",
      "price": 99.99,
      "discount": 5,
    ...
    },
    {
      ...
      "name": "Wireless Speaker",
      "rating": 4.4,
      "description": "Enjoy high-quality sound without the need for wires with this wireless speaker.",
      "price": 129.99,
      "discount": 10,
    ...
    },
    {
      ...
      "rating": 4.2,
      "description": "Stream your favorite movies and shows on your TV with this streaming device.",
      "price": 59.99,
      "discount": 5,
    ...
    },
    {
      ...
      "name": "Air Purifier",
      "rating": 4.9,
      "description": "Breathe cleaner air with this air purifier that removes allergens and pollutants.",
      "price": 199.99,
      "discount": 20,
    ...
    },
    {
      ...
      "name": "Smart Camera",
      "rating": 4.5,
      "description": "Keep an eye on your home or office from anywhere with this smart camera.",
      "price": 99.99,
      "discount": 10,
      "images":"../../assets/camera.jpeg"
    }
  ...
  filter(){
   this.filteredArray= this.users.filter(x => x.name.toLocaleLowerCase().includes(this.filterByName.toLocaleLowerCase()))
